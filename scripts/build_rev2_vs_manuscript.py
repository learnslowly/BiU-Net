...
Usage: python scripts/build_rev2_vs_manuscript.py [supplementary.docx]
Writes Results/rev2_vs_manuscript_revision2.csv (never overwrites originals).
"""
import os
import sys
...
ANCHORS = {
    "1KGP_chr22": ("1KGP", 22, "v3low_ref_g22", 70, {"5%": 0, "15%": 1, "25%": 2}),
    "SGDP_chr22": ("SGDP", 22, "ft_sgdp_full", "best", {"5%": 6, "15%": 7, "25%": 8}),
    "SGDP_chr19": ("SGDP", 19, "ft_sgdp_full", "best", {"5%": 12, "15%": 13, "25%": 14}),
}
...
path = os.path.join(OUTDIR, "rev2_vs_manuscript_revision2.csv")
