...
Usage: python scripts/build_finetuning_tables.py
Writes Results/finetuning_per_chromosome.csv
...
ARMS = {
    "1KGP": {"GW-M": ("1KGP_genomewide", 70), "GW-M+FT": ("1KGP_finetuned", 30)},
    "SGDP": {"GW-M": ("SGDP_genomewide", "best"), "GW-M+FT": ("SGDP_finetuned", "best")},
}
...
p1 = os.path.join(OUTDIR, "finetuning_per_chromosome.csv")
...
p2 = os.path.join(OUTDIR, "finetuning_summary.csv")
