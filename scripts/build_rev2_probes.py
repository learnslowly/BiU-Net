...
Usage: python scripts/build_rev2_probes.py
Writes Results/rev2_alignment_ablation_revision2.csv
       Results/rev2_alignment_ablation_chr19_revision2.csv
       Results/rev2_specialisation_revision2.csv
"""
import os
import sys
...
ABLATION = {
    "no reference": ("ft_sgdp_noref", None,
                     "SGDP training split only"),
    "unaligned reference": ("ft_sgdp_g22", None,
                            "1KGP samples merged on the 1KGP variant axis"),
    "aligned reference": ("ft_sgdp_aln", None,
                          "1KGP samples projected onto the SGDP variant axis"),
}
# label -> (dataset, chrom, runId, epoch)
SPECIALISATION = {
    "1KGP chr22 genome-wide": ("1KGP", 22, "v3low_ref_g22", 70),
    "1KGP chr22 specialised": ("1KGP", 22, "v3low_chr22_ft", 30),
    "SGDP chr19 genome-wide": ("SGDP", 19, "ft_sgdp_full", "best"),
    "SGDP chr19 specialised": ("SGDP", 19, "ft_sgdp_chr19_ft", "best"),
}
...
p1 = os.path.join(OUTDIR, "rev2_alignment_ablation_revision2.csv")
...
p3 = os.path.join(OUTDIR, "rev2_alignment_ablation_chr19_revision2.csv")
...
p2 = os.path.join(OUTDIR, "rev2_specialisation_revision2.csv")
